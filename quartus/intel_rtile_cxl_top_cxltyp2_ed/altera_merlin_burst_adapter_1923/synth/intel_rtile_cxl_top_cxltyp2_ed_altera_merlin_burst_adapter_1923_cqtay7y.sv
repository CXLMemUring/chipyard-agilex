...
// parameterization.
// -----------------------------------------------------
module intel_rtile_cxl_top_cxltyp2_ed_altera_merlin_burst_adapter_1923_cqtay7y 
#(
    parameter 
...
(
    ...
    generate if (COMPRESSED_READ_SUPPORT == 0) begin : altera_merlin_burst_adapter_uncompressed_only
        ...
        if(PIPE_INPUTS == 1) begin: pipe_inputs
            intel_rtile_cxl_top_cxltyp2_ed_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_ei5g6li # (
                .SYMBOLS_PER_BEAT (1),
