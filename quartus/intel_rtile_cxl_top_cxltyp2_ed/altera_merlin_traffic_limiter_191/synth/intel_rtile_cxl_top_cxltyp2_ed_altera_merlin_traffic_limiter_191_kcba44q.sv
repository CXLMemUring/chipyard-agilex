...
module intel_rtile_cxl_top_cxltyp2_ed_altera_merlin_traffic_limiter_191_kcba44q
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
   ...
   generate
      if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
         ...
         for (j = 0;j < MAX_DEST_ID; j = j+1) begin : trans_sequence_per_fifo
            ...
            intel_rtile_cxl_top_cxltyp2_ed_altera_merlin_traffic_limiter_altera_avalon_sc_fifo_191_phez6qq #(
                  .SYMBOLS_PER_BEAT   (1),
