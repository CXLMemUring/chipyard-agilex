...
# ACDS 23.3 104 linux 2024.06.14.16:53:35
...
# ----------------------------------------
# If port_1_ram is one of several IP cores in your
...
TOP_LEVEL_NAME="port_1_ram.port_1_ram"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/yerjin0517/intelFPGA_pro/23.3/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [port_1_ram::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [port_1_ram::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [port_1_ram::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [port_1_ram::get_design_libraries]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [port_1_ram::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [port_1_ram::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [port_1_ram::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [port_1_ram::get_dpi_libraries "$QSYS_SIMDIR"]]
