...
# Reset gen
#set_false_path -to {cxl_ip|io_pll_rstn*|clrn}
#set_false_path -to {cxl_ip|io_pll_rstn[0]|d}
set_false_path -to intel_rtile_cxl_top_inst|intel_rtile_cxl_top_0|cxl_t2ip_sip_top|gen_clkrst|sbr_rstn_pipe*|clrn
set_false_path -to intel_rtile_cxl_top_inst|intel_rtile_cxl_top_0|cxl_t2ip_sip_top|gen_clkrst|cam_warm_rstn_pipe*|clrn
set_false_path -to intel_rtile_cxl_top_inst|intel_rtile_cxl_top_0|cxl_t2ip_sip_top|gen_clkrst|cam_cold_rstn_pipe*|clrn
set_false_path -to intel_rtile_cxl_top_inst|intel_rtile_cxl_top_0|cxl_t2ip_sip_top|gen_clkrst|sbr_rstn_pipe[0]|d
set_false_path -to intel_rtile_cxl_top_inst|intel_rtile_cxl_top_0|cxl_t2ip_sip_top|gen_clkrst|cam_warm_rstn_pipe[0]|d
set_false_path -to intel_rtile_cxl_top_inst|intel_rtile_cxl_top_0|cxl_t2ip_sip_top|gen_clkrst|cam_cold_rstn_pipe[0]|d
#set_false_path -to ed_top_wrapper_typ2_inst|ccv_afu_avmm_wrapper_inst|inst_ccv_afu_wrapper|inst_mwae_top|inst_mwae_top_fsm|state.CHECK_CONFIG
#set_false_path -to ed_top_wrapper_typ2_inst|ccv_afu_avmm_wrapper_inst|inst_ccv_afu_wrapper|inst_mwae_top|gen_alg_1a_top.inst_alg_1a_top|gen_alg1a_top_fsm_sc_response.inst_alg_1a_verify_sc_response|pipe_7_compare_result[*]
